...
def ai_view(request):
    if request.method == 'POST':
        ...
        return render(request, 'ai_trivia.html', {'questions': json.dumps(data) })
        # print(answer)
